                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-2">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                <span className={`px-3 py-1 rounded-full text-xs font-medium capitalize ${userData.profileType === 'professional'
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-scale-in relative overflow-hidden">
                        ...
                        <div className="mt-8 flex gap-3">
                            ...
                            <button
                                ...
                                className={`flex-1 py-2.5 px-4 text-white rounded-lg font-medium transition-colors shadow-md disabled:opacity-70 ${isEmailOtpSent
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-scale-in relative overflow-hidden">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                disabled={loading}
                                className={`w-full p-4 rounded-xl border-2 text-left flex items-center justify-between transition-all duration-200 group ${userData.profileType === 'personal'
                            ...
                            <button
                                ...
                                disabled={loading}
                                className={`w-full p-4 rounded-xl border-2 text-left flex items-center justify-between transition-all duration-200 group ${userData.profileType === 'professional'
