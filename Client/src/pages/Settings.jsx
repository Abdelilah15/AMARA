...
const Settings = () => {
  ...
  return (
    <div className='flex justify-center min-h-screen bg-gray-50 p-6 pt-24'>
      <div className="w-full max-w-3xl mx-auto"> {/* Conteneur centré limité en largeur */}
          ...
          <div className="p-2">
            ...
            >
                <div className="flex items-center gap-4">
                    {/* Icône optionnelle pour embellir */}
